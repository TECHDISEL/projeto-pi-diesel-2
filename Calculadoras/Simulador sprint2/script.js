function calcular_diesel_tanque_deitado(){
    ...
    O volume atual do Diesel é de (aproximadamente): <b>${Math.floor(volume_diesel_litros)}L</b>.
    <br><br>
    É importante delimitar um volume mínimo de estoque do Diesel, para que seu negócio não tenha quebra de fluxo. <br>
    De acordo com o nosso cálculo, em cima dos dados informados, é possível dizer que o volume mínimo que você deve manter no seu tanque é de <b>${dias_reabastecimento * diesel_utilizado_por_dia}L</b>.
    <br><br>
